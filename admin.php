...
<html lang="en">
  <head>
    ...
    <title>Website Crypto | Admin</title>
  ...
  <div class="container">
    ...
    <footer class="text-center p-3 bg-danger-subtle">
			<div>
				<a href="https://www.instagram.com/michl3669"><i class="bi bi-instagram h2 p-2 text-dark"></i></a>
				<a href="https://twitter.com/Fjktmic24"><i class="bi bi-twitter h2 p-2 text-dark"></i></a>
				<a href="https://wa.me/+6285647915756"><i class="bi bi-whatsapp h2 p-2 text-dark"></i></a>
			</div>
			<div>Michael Wibowo Wibisono &copy; 2025</div>
    </footer>
    <!-- footer end -->
